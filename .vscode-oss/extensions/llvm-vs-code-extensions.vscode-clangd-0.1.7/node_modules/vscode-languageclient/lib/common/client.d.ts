...
export declare abstract class BaseLanguageClient {
    ...
    getFeature(request: typeof SemanticTokensRequest.method): DynamicFeature<TextDocumentRegistrationOptions> & TextDocumentProviderFeature<SemanticTokensProviders>;
